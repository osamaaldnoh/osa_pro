...
class ValidateCheck {
  static String? validateEmail(String? value) {
    ...
    if (value!.isEmpty) {
      return '\u26A0 ${AppString.emailMustBeRequired}';
    } else if (isValid == false) {
      return '\u26A0 ${AppString.enterValidEmailAddress}';
    }
    return null;
  }
  ...
  static String? validatePassword(String? value, String? message) {
    if (value == null || value.isEmpty) {
      ...
      return '${AppString.minimumPasswordIs8Character}';
    }
    return null;
  }
  ...
  static String? validateConfirmPassword(String? value, String? password) {
    if (value == null || value.isEmpty) {
      return '${AppString.confirmPasswordMustBeRequired}';
    } else if (value != password) {
      return '${AppString.confirmPasswordNotMatched}';
    }
    return null;
  }
}
